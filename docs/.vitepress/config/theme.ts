...
export const themeConfig: DefaultTheme.Config = {
  ...
  // 导航栏右侧社交链接配置
  socialLinks: [
    { icon: 'github', link: 'https://github.com/Oldmemorie/Oldmemorie.github.io' },
    {
      icon: {
      ...
      link: 'https://gitee.com/Oldmemorie/Oldmemorie'
    },
    {
      icon: {
    ...
    },
    {
      ...
      link: 'https://cnadmin.Oldmemorie.top/'
    }
  ],
